...
const DriverRequestSingle = ({data}) => {
  return (
    <div className="flex  justify-center items-center gap-2">
      ...
      <div className="">
        ...
        <div className="flex justify-between items-center gap-2">
          <Link to={`deatils/${1}`}>
            <button
              className="font-semibold text-base bg-secondary-color rounded-tl-xl rounded-br-xl  px-3 py-2  hover:scale-105 transition delay-100  text-nowrap
            "
            >
              See Details
            </button>
...
export default DriverRequestSingle;
