...
//* Modal Table
import DeleteCandidateModal from "../../Components/SuperAdminPages/VotingCandidatePage/DeleteCandidateModal";
...
const VotingCandidatePage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("/data/candidateList.json");
    ...
    >
      ...
      <div className="bg-secondary-color w-full p-4   rounded-tl-xl rounded-tr-xl">
        <div className=" w-[95%] mx-auto  flex items-center justify-between">
          <p className="text-3xl  font-semibold">Voting Candidate List</p>
...
export default VotingCandidatePage;
